const API_URL = "https://www.omdbapi.com/?i=tt3896198&apikey=9a3eaeb5&s=";
const API_URL_SEARCH = "https://www.omdbapi.com/?i=";
...
function showMovies(movies){
   ...
   movies.forEach(async function(movie){
       const movieData = await fetch(API_URL_SEARCH+movie.imdbID+"&apikey=9a3eaeb5&s=");
